...
struct NorthFaceProducts: View {
    ...
    @State private var northURL: String = ""
           ...
           docRef.getDocument { (document, error) in
               if let document = document, document.exists {
                   ...
                   if self.gender == "Male" {
                       ...
                       switch self.clothes {
                       case "Shirts":
                           field = "northfaceWomenT"
                       case "Hoodies":
                           field = "northfaceWomenH"
                       case "Pants":
                           field = "northfaceWomenB"
                       default:
                           break
                       }
                   }
    ...
    var body: some View {
        ...
        //Packaged used for getting HTML URL Images
        ...
        //function to open safari when clicked
            func openURLInSafari(urlString: String) {
                if let url = URL(string: urlString) {
                    print("Opening URL: \(urlString)") //Check to make sure URL's are working
...
/*struct NorthFaceProducts_Preview: PreviewProvider {
